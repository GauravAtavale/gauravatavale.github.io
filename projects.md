...
<div class="blog-container">
  <header class="blog-header">
    ...
    <p class="page-description">Things I am building, learning, and experimenting with.</p>
  </header>
        ...
        <div class="post-content">
          <div class="post-meta">
            ...
            <div class="meta-right">
              <span class="reading-time">
                ...
                {% unless words contains "-" %}{{ words | plus: 250 | divided_by: 250 | append: " minute read" }}{% endunless %}
              </span>
            </div>
          </div>
          ...
          <div class="post-footer">
            <div class="categories">
              {% for tag in post.tags %}<span class="category">{{ tag }}</span>{% endfor %}
